...
@ApiModel(value = "ResultInfo",description = "返回结果")
public class ResultInfo implements Serializable{
    private static final long serialVersionUID = -5996425918881028431L;
    /**
     * 结果码
     */
    @ApiModelProperty(value = "points",example = "0")
    private String returnCode;

    /**
     * 结果码描述
     */
    @ApiModelProperty(value = "returnMessage",example = "成功")
     ...
     * 返回结果数据
     */
    @ApiModelProperty(value = "data",dataType = "java.util.ArrayList")
    private Object data;
