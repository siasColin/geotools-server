 ...
 * @Description:
 */
public class PointFilterByPolygonThread implements Callable<Map<String, Object>> {

    private List<Map<String,Object>> resourceList;
    private Polygon polygon;

    public PointFilterByPolygonThread(List<Map<String,Object>> resourceList,Polygon polygon) {
